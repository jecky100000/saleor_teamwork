...
class MenuItemForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        print('oooooooooooooooooooooooooooooo',obj)
        if obj:
    ...
    def clean(self):
        ...
        print('firstxxxxxxxxxxxxxxxxxxxxxxxxxxxx',linked_object.content_json)
    ...
    def save(self):
        linked_object = self.cleaned_data.get("linked_object")
        print('linked_object.................',linked_object.get_absolute_url())
        for x in linked_object.content_json:
            print('really..................',x)
